...
Which source flips is corpus-specific, and so is how much it matters. On MovieLens two sources flip. The consequential one is $cf$: Shapley scores it
$+0.01526$, the second most valuable source in the system, where ablation
scores it $-0.00501$ and marks it as worth removing. The gap is $0.0203$, or
$39\%$ of $v(\G)$. The other flip, $ct$, has both estimates within $10^{-3}$ of
zero and is not a meaningful disagreement. The strongest source overall is
$seq$ at $+0.02943$. On Gowalla it falls on $pop$, at $12\%$ of $v(\G)$. On Amazon-VG it
