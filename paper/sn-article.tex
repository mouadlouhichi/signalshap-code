...
Across three timestamped corpora spanning a $30\times$ density range, every
...
\paragraph{Corpora}
Three real datasets spanning a $30\times$ density range
...
Gowalla      & 5\,910 & 68\,443 & $0.089\%$ & 11\,623 & $0.453^{\dagger}$ & $6$ / $16$ & no \\
\botrule
\end{tabular}
\smallskip
...
consistency rather than by outcome. Recall improved to $0.453$. The robustness
sweep then measured the curve directly:
$N_{\max}=5\,811 \to 0.416$, $11\,623 \to 0.453$, $23\,246 \to 0.471$. Doubling
the pool buys $+0.021$.
...
fast enough in the unsampled region between $23\,246$ and $68\,443$ to change
...
\midrule
Gowalla      & $cf$  & $+0.00503$ & $+0.00647$ & $+0.00143$ & \\
             & $ct$  & $+0.00925$ & $+0.00952$ & $+0.00027$ & \\
             & $pop$ & $-0.00118$ & $+0.00087$ & $+0.00204$ & \textbf{flip, material} \\
             & $rec$ & $-0.00005$ & $+0.00035$ & $+0.00039$ & flip, negligible \\
             & $seq$ & $+0.00393$ & $+0.00350$ & $-0.00043$ & \\
\botrule
\end{tabular}
\end{table}
...
$9.9\%$ of $v(\G)$: ablation scores the popularity signal negative where
...
$ct \succ cf \succ seq \succ pop \succ rec$ (Gowalla). Pairwise Kendall $\tau$
between corpora is $0.40$ (MovieLens--Amazon), $0.00$ (MovieLens--Gowalla) and
$0.60$ (Amazon--Gowalla), none significant at $n=5$ sources. We therefore make no cross-corpus consistency claim. An earlier
...
controlled density comparison; the density ordering is clean --- $0.089\%$,
$0.469\%$, $2.697\%$, a $30\times$ spread with no adjacent pair closer than
$5.3\times$ --- but the corpora are not otherwise matched, and we do not
