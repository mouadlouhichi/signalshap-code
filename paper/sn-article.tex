...
\tikzset{
  ...
  snflow/.style={-{Stealth[length=4.5pt,width=3.5pt]}, draw=snGrey,
    line width=0.7pt},
  sndata/.style={-{Stealth[length=4.5pt,width=3.5pt]}, draw=snGrey!65,
    line width=0.6pt, dashed, dash pattern=on 2.2pt off 1.6pt},
  snlbl/.style={font=\snFigSub, inner sep=1.6pt, text=snGrey},
}
...
\draw[{Stealth[length=4.5pt,width=3.5pt]}-, draw=snShap!75, line width=0.7pt,
      dotted] (fuse.north) -- node[snlbl,right,text=snShap!85]{no path} (diag.south);
