...
substantially redundant with $seq$ and $pop$ (the pairwise interaction indices are $-0.056$ for $cf|seq$ and $-0.026$ for $cf|pop$, the two most negative pairs), so in the grand coalition its scores add noise the others
