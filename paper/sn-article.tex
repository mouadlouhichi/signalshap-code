...
Efficiency holds to machine precision on every corpus, with worst-case
...
The result is unambiguous and reproducible. Shapley satisfies symmetry exactly
...
Robustness sweeps, segment analysis, and fusion are strongest on MovieLens-1M.
