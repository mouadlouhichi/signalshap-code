...
event. \texttt{scripts/audit\_global\_time.py} measures the exposure; on a
pilot corpus roughly half of pooled training events postdate the median test
event. This is the standard leave-last-out protocol in the recommender
...
ten-seed means; an earlier version
