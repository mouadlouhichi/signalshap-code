...
components does not invalidate it: it is exactly the right quantity for a removal decision, as our own experiments in Section~\ref{sec:estimands}
confirm.
...
of the predecessor coalition. It is worth being precise about where Shapley
...
predecessor coalitions respectively. We report these in
...
where $\operatorname{rank}_g(i)$ is the position of $i$ in source $g$'s own
top-$N_g$ list and the sum runs over the sources that retrieved it. Both keys
...
disagreement on $cf$ is present under both. The reported conclusions are therefore unaffected by the change, and the game
...
$seq$ & embedding dimension   & $64$    & shifted-PPMI SVD \\
      & PPMI shift            & $\log k_{\mathrm{s}}$, $k_{\mathrm{s}} = 1$ & i.e.\ unshifted PPMI \\
...
Game  & $N_{\max}$            & $600$ / $600$ / $11\,623$ & ML-1M / Amazon-VG / Gowalla \\
      ...
      & NDCG cutoff $K$       & $10$    & \\
      & empty-coalition baseline & $\mathbb{E}[\NDCG_{10}]$ & Equation~(\ref{eq:baseline}); deterministic, no seed \\
...
Banzhaf, $q=0.25$ and $q=0.75$. Only Shapley sums to $v(\G)$; for the others
...
MovieLens-1M: ten-seed mean with a $95\%$ interval, and the number of the ten
seeds on which the index is negative. Negative entries indicate redundancy.
...
The $\LOOr$ and gap columns are seed-42 point estimates; we have since computed
ten-seed intervals for both on MovieLens-1M, where the material $cf$ case is
stable in every respect ($\LOOr = -0.00477$, negative on $10/10$ seeds; gap
$= +0.02033$, $[+0.01995, +0.02071]$, positive on $10/10$). The near-zero
...
noise and we do not interpret them. Amazon-VG and Gowalla intervals for
$\LOOr$ are not yet computed.}
\label{tab:loo}
...
\midrule
MovieLens-1M & $cf$ & $-0.00519$ & $+0.01545$ & $+0.01574\ [+0.01547,+0.01602]$ & $+0.02064$ & \textbf{flip, material} \\
             & $ct$ & $+0.00044$ & $-0.00009$ & $-0.00018\ [-0.00024,-0.00012]$ & $-0.00053$ & flip, negligible \\
             & $pop$ & $+0.00065$ & $+0.00637$ & $+0.00646\ [+0.00639,+0.00652]$ & $+0.00572$ &  \\
             & $rec$ & $-0.00005$ & $+0.00026$ & $+0.00024\ [+0.00015,+0.00034]$ & $+0.00031$ & flip, negligible \\
             & $seq$ & $+0.01635$ & $+0.02937$ & $+0.02992\ [+0.02966,+0.03018]$ & $+0.01302$ &  \\
\midrule
Amazon-VG    & $cf$ & $+0.00845$ & $+0.01926$ & $+0.01979\ [+0.01943,+0.02016]$ & $+0.01081$ &  \\
             & $ct$ & $+0.00002$ & $+0.00187$ & $+0.00195\ [+0.00184,+0.00205]$ & $+0.00185$ &  \\
             & $pop$ & $+0.00308$ & $+0.00157$ & $+0.00178\ [+0.00167,+0.00189]$ & $-0.00152$ &  \\
             & $rec$ & $+0.00023$ & $-0.00047$ & $-0.00049\ [-0.00052,-0.00046]$ & $-0.00070$ & flip, negligible \\
             & $seq$ & $+0.00758$ & $+0.01909$ & $+0.01883\ [+0.01868,+0.01898]$ & $+0.01151$ &  \\
\midrule
Gowalla      & $cf$ & $+0.00729$ & $+0.00711$ & $+0.00642\ [+0.00632,+0.00652]$ & $-0.00018$ &  \\
             & $ct$ & $+0.00528$ & $+0.00674$ & $+0.00961\ [+0.00956,+0.00966]$ & $+0.00146$ &  \\
             & $pop$ & $-0.00151$ & $+0.00055$ & $+0.00092\ [+0.00086,+0.00099]$ & $+0.00206$ & \textbf{flip, material} \\
             & $rec$ & $+0.00001$ & $+0.00038$ & $+0.00035\ [+0.00031,+0.00039]$ & $+0.00037$ &  \\
             & $seq$ & $+0.00070$ & $+0.00213$ & $+0.00360\ [+0.00355,+0.00366]$ & $+0.00143$ &  \\
\botrule
\end{tabular}
\end{table}
...
and the game measures ranking-stage rather than end-to-end contribution. The decisive experiment, whether Shapley credit leads to better subsystem decisions than ablation, we did run, as an end-to-end retirement simulation,
