...
> **SUPERSEDED.** This file is revision history for `v1.1.1` only. The authoritative specification is **`SignalShap_Implementation_Spec.md`**. Do not build, cite, or edit from this document.
